...
defineProps<{ kind: "GAMEPAD" | "FREE" | "TROPHY" | "ROCKET" }>();
</script>

<template>
  <svg v-if="kind === 'GAMEPAD'" class="ft-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
  ...
  <svg v-else-if="kind === 'FREE'" class="ft-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
  ...
  <svg v-else-if="kind === 'TROPHY'" class="ft-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
  ...
  <svg v-else-if="kind === 'ROCKET'" class="ft-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
