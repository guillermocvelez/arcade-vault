...
defineProps<{ kind: "HEART" | "BROWSER" | "PLANT" }>();
</script>

<template>
  <svg v-if="kind === 'HEART'" class="hl-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
  ...
  <svg v-else-if="kind === 'BROWSER'" class="hl-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
  ...
  <svg v-else-if="kind === 'PLANT'" class="hl-icon" viewBox="0 0 16 16">
    <g fill="currentColor">
